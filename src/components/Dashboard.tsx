    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400 mt-1">Vue d'ensemble de vos données logistiques</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
          <h3 className="text-xl font-semibold text-white mb-4">Performances Mensuelles</h3>
          <div className="h-64 flex items-center justify-center bg-gray-900 rounded-lg">
            <div className="text-center">
              ...
              <p className="text-gray-500 text-sm">Intégration des graphiques à venir</p>
            </div>
          </div>
        </div>
            ...
            {recentActivity.map((activity) => (
              <div key={activity.id} className="flex items-center justify-between p-3 bg-gray-900 rounded-lg">
                <div>
                  ...
                  <p className="text-gray-400 text-sm">{activity.dossier}</p>
                </div>
      ...
      <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-xl font-semibold text-white">Aperçu des Données</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-gray-900 rounded-lg p-4">
            <h4 className="text-gray-300 font-medium mb-2">Expéditions Aujourd'hui</h4>
            <p className="text-3xl font-bold text-white">24</p>
          </div>
          <div className="bg-gray-900 rounded-lg p-4">
            <h4 className="text-gray-300 font-medium mb-2">En Transit</h4>
            <p className="text-3xl font-bold text-yellow-400">12</p>
          </div>
          <div className="bg-gray-900 rounded-lg p-4">
            <h4 className="text-gray-300 font-medium mb-2">Livrées</h4>
