    ...
    if (printRef.current) {
      ...
      if (printWindow) {
        printWindow.document.write(`
          ...
          <html>
            <head>
              <title>Confirmation de Transport Funéraire</title>
              <meta charset="utf-8">
              <style>
                * {
                  margin: 0;
            ...
            <body>
              <div class="document-container">
                <div class="logo-top-left">
                  ...
                  <p style="font-size: 0.75rem; font-weight: 600; text-align: center;">SkyMasters</p>
                </div>
                ...
                <div class="header">
                  <div style="display: inline-flex; align-items: center; justify-content: center; width: 3rem; height: 3rem; background: rgba(255,255,255,0.1); border-radius: 50%; margin-bottom: 0.75rem;">
                ...
                <div class="main-content">
                  ...
                  <div class="info-card transport">
                    ...
                    <div class="grid-2">
                      ...
                      <div>
                        ...
                        <div class="field-value">${currentData.flights[0].airline}</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="info-card flight">
                    ...
                    <div style="margin-bottom: 1.5rem;">
                      ...
                      <div class="card-title">${currentData.flights[0].flightNumber}</div>
                    </div>
                    ...
                    <div class="route-section">
                      <div>
                        ...
                        <div class="airport-info">
                          ${currentData.flights[0].departure.airportCode} | ${currentData.flights[0].departure.airport}
                        </div>
                        <div class="datetime-info">
                          📅 ${new Date(currentData.flights[0].departure.date).toLocaleDateString('fr-FR', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}
                        </div>
                        <div class="datetime-info">
                          🕐 ${new Date('2000-01-01T' + currentData.flights[0].departure.time).toLocaleTimeString('fr-FR', { hour: '2-digit', minute: '2-digit', hour12: false })}
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div class="airport-info">
                          ${currentData.flights[0].arrival.airportCode} | ${currentData.flights[0].arrival.airport}
                        </div>
                        <div class="datetime-info">
                          📅 ${new Date(currentData.flights[0].arrival.date).toLocaleDateString('fr-FR', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}
                        </div>
                        <div class="datetime-info">
                          🕐 ${new Date('2000-01-01T' + currentData.flights[0].arrival.time).toLocaleTimeString('fr-FR', { hour: '2-digit', minute: '2-digit', hour12: false })}
                        </div>
                      </div>
                    </div>
                  </div>
